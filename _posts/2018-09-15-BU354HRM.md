...
- HRP: a process used to determine future human resource requirements by anticipating future business demands, analyzing the impacts of these demands on the organization, determining the current availability of human resources, and making decisions on how to effectively acquire and utilize firms’ human resources
- right people with right skills at the right time
- above is not enough, also need right environment and peopling doing the right things
- different strategy -> different HR plan
  - growth/expansion strategy -> aggresive hiring, training, and promotion of employees
  - retrenchment/cost reduction strategy ->layoffs and early retirement
...
1. **forecast demand for resources**: how many human resources will we need, when will we need them, and where will we need them?

   - identifying **causes** that will drive demand
     - demographic impacts
       - age -> insight into future retirement
     - turnover
       - resignations or terminations
       - understand and predict employee departures
     - legal changes
       - easy to predict, unclear implications
       - impact of the Canadian Human Rights Act is unclear
       - equal pay for work of equal value will have profound implications
     - technological changes
       - normally difficult to predict
       - can create demand/supply
       - reduce employment in one department while increasing it in another (e.g. computers)
     - competitors
       - employment in tranditional sectors barely grows because of foreign competition and a push for productivity improvement
       - high-tech and electronic industries -> lower prices, larger markets and additional employment
       - create demand: employees leave for the competitor
     - strategic plan
       - long-range objectives -> numbers and types of employees needed in the future
     - budgets and revenue forecasts
       - short-run influence
     - new ventures
       - means new hr demands
     - organizational and job design
       - roles created or eliminated
   - techniques
     - **expert forecasts**
       - rely on those who are knowledgeable
     ...
     - **trend projection forecasts**
       - **extrapolation**
         ...
         - e.g. 20 worker hired/month -> 240 workers hired next year
       - **indexation**
         - estimating future employment needs by matching employment growth with a selected index
         - e.g. using sales figures in dollars
       - both are crude, short-run approximation because of assumption of causes of demand are constant
       - inaccurate for long-range hr projections
     - **budget and planning analysis**
       - detailed budgets and long-range plans
     - **new-venture analysis**
       - compare with firms that already perform similar operations
     - **computer-based simulation and predictive models**
       - effective
       - a series of mathematical formulas that simultaneously use extrapolation, indexation, survey results, and estimates of workforce changes to compute future human resource need
   - forecast -> hr requirements
     - **staffing table**
       - lists the future employment needs for each type of job

2. **assess internal and external supply of resources**: what resources do we have available both inside  the organization and in the external environment and what skills and competencies do these resources possess?

   - human resource audits
     - **skills inventories**
       - inventory that catalogues the capabilities found in the organization's workforce
       - both managerial and nonmanagerial
       - must be updated periodically
     - **management and leadership inventories**
       - comprehensive reports of available management and leadership capabilities in the organization
       - must be updated periodically
       - leadership at all levels: leadership profiles
     - **replacement charts**
       - visual representation of who will replace whom in the event of a job opening
       - information comes from the human resource audit
       - increasing unecessary to include age
       - two var: performance and promotability
       - **shortcoming: static, little information**
     - **replacement summaries**
       - supplement and supplant the replacement chart

   - **Markov analysis** (in class example)
     - a faily simple method of predicting the internal supply of human resources in the future
     - useful where jobs do not fluctuate rapidly
     - easy to use
     - employees move from one job to another on a regular basis
     ...
     - previous year -> next year: can be erroneous if previous year was atypical
   - external supply estimates
     - **labour market analysis**: defines the people potentially available for work
     - unemployment rate: approximate of how difficult
     - local developments and demograhic trends have the most significant impact
     - Canadian Temporary Foreign Worker program: a strong source of external workers
   - community attitudes
     - anti-business or nongrowth attitudes -> present employers move 
   - demographic trends
     - long-term development that affects external supply
     - trends are known years in advance of their impact
     - COPS: provides a highly detailed projection of the Canadian economy up to 10 years in the future

3. **develop HR objectives**: identifies what the planners expect to accomplish as a result of their actions

   - **to manage oversupply of HR**:

     1. headcount reduction:
        1. **layoff**: temporary withdrawl of employment to workers, when in short-run surplus
        2. **leave without pay** (to attend college/other personal interests)
        3. **incentives for voluntary separation**, buyout
        4. **termination** (outplacement: help employees get employed outside): permanent separation, usually emloyees fired as a form of discipline

     2. attrition strategies

        - normal separation of employees from an organization as a result of resignation/retirement/death
        - iniatiated by worker, not company
        - key component is resignation, voluntry separation
        - slow way, presents fewest problems
     ...
     3. alternative work arrangements
        1. **job sharing**
           - also called job splitting
           - one posision, multiple employees
           - used to avoid layoffs
        2. **using part-time employees**
           - usually no benefits
           - increase flexibility
           - growing number of women in the labour force with a preference for part-time positions
           - high demand in service industries
           - need for cost-cutting
           - public costs: unable to work -> serious financial problems
   ...
   - **manage shortages of employees:**
     ...
     1. **hire employees**
        ...
        1. full-time employees
           - the only alternative for emportant roles
           - require more detailed look at competencies
           - probation
        2. part-time employees
           - flexible
           - service business and more

     2. **contract out the work**

        - freelancer
        - not employees, governed under contract law
        - e.g. consultants: professionals who provide expert advice and counsel in a particular area
        - can work multiple contracts
        - no benefits, own equipment and supplies
        - 5 key tests to determine whether contractor/employee?
          - control (more control -> more likely an employee)
          - ownership of tools (own tools -> contractor)
          - profit (income = price of service - cost of serice -> contractor)
          - risk of loss (no risk of loss -> employee)
          - payment (payment at regular intervals -> employee)

        - outsourcing
          - formal agreement an organization makes with a third party to perform a service rather than using internal sources
          - non-core work
          - trend to outsource HR related functions
        - crowdsourcing
          - outsource to an undefined(large) network of people in the form of an open call
          - innovative ideas at relatively low cost
          - reduce costs
          - crowd

     3. **developing employees internally**

        - promotions and replacement charts
...
4. **design and implement HRM programs**: decide what type of human resource programs will be developed to achieve their objectives

5. **establish program evaluation**: evaluate effectiveness using some form of quantitative or qualitative measurement: is there a tangible link between investments in human resource programs and organizational sustainability and to what degree?

   - **people equity**: how an organization measures and manages its human capital to maximize its value
   - ACE (alignment, capabilities, and engagement):
     - alignment: defree of fit between strategy and people's activities
     - capabilities: the talent resources to execute the strategy
     - engagement: degree of commitment

### Human resource information system (HRIS)

- collect, record, store, analyze, and retrieve data concerning an organization's human resources

- software w/ electronic database

- major stakeholders: HR professionals, managers, and employees

- breadth and size

  - e.g. small firm -> simple HRIS

  - nonrelational system: high probability of error

  - self-contained and relational

    - each HR module relates to one another, information needs to be only entered once
    - prevent errors and catch inconsistenceis
    - **referential integrity**: policies operationalized/implemented consistently

    - enterprise-wide systems: single enterprise solution has everything: sales, operations, distribution, and HR
    - **intranet**: organization's internal website
    ...
    - components:
      ...
      - career planning
      - compensation, benefits and pension administration
...
- reporting capabilities
  ...
  - regular repost: employee records, salary and benefit details, retirement benefits, etc.
  - sophisticated: applicant tracking, recruitment source evaluation and costing, performance appraisal recoridng, compensation and payroll, training records maintenance, and human resource forecasts

- privacy and security

  - all information available to HR staff and key managers
  - sensitive information: need-to-know basis
  - security profiles: based on role and whether holder of the role can view/change

- benefits of HRIS

  - increased efficiency
    - enabled HR to decrease its involvement in administrative transactions and compliance requirements
    - more accurate, timely, and accessible
    - able to provide just-in-time service on as-needed basis
  - increased effectiveness
    - focus more on strategic issues -> make better decisions
    - **predictive analysis**: tthe process of selecting, exploring, analyzing, and modelling data to create better business outcomes
  - increased contribution to organizational sustainability
    - effectively manage talent, optimize skills and competencies
    - **talent management**: a systemic attraction, identification, development, engagement/retention and deployment of those individuals with high potential who are of particular value to the organization
    - e.g. SAP, People Soft
  - increased visibility
    - interact at a more sophisticaed level with client groups
    - enhanced HR competencies

### Human resource accounting (HRA)

- the process of identifying, measuring, accounting, and forecasting the value of human resources in order to facilitate effective management of an organization
- managerial tool, better decisions
...
- **bona fide occupational requirement**: legal discrimination

  - clothing store hiring femail models
  - relegious schools hiring members of specific faith
...
- direct vs indirect:
  ...
  - **systemic discrimination** (indirect): 
    ...
    - e.g. minimum height and weight requirements for employment with police forces

    - **Canadian Human Rights Commission (CHRC)**: supervises the implementation and adjudication of the Canadian Human Rights Act.

      1. race and colour

         - require photograph of applicant

         - not always in favour of the complaint
         - First Nations people are underutilized in the workforce

      2. national or ethnic origins

         - sometimes indirect, somtimes very clear
         - name discrimination (perfers Anglophone names)
      ...
      4. age
         ...
         - exception: reached the normal age of retirement for employees working in similar positions

      5. sex

         - fire employee from pregnancy/reduce number of shifts to force a quit
         - employer may not discriminate against a pregnant employee who refuses to work because of a risk to the person’s health and safety
         - separate policies for men and women
         - BFOR test:
           - is the standard rationally connected to the performance of the job?
           - was the standard established in an honest belief that it was necessary to accomplish the purpose identified in stage one?
           - is the standard reasonably necessary to accomplish its purpose

      6. sexual orientation

         - same sex couples treated the same way as heterosexual couples
         - e.g. dental benefits to the same-sex partners of employees

      7. gender identity

         - seven provinces and territories added this in 2015
         - a transgender bill

      8. marital status

         - single-parent families/nontraditional families (e.g. resulting from common-law marriages) far more numerous
         - e.g. not employing a woman because husband employed at the same company

      9. family status

         - nepotism: favouring family members when hiring
         - duty to accomodate employees with child care obligations unless in undue hardship

      10. disability

         - **reasonable accommodation**: employer should take reasonable measures to make available a suitable job to a person with a physical handicap if it does not impose undue hardships on the organization 
         - alcohol/drug-dependent: also a disability, offer assistance program but no need to accept long-term absences
         ...
         - employee with disability vs other workers: 8% said former better, 80% said no difference, only 6% said former is worse

      11. pardoned convicts

          - discrimination against a convicted person if a pardon has been issued for the offence

          - refused employment on the basis of their arrest (that did not lead to conviction)
  ...
  - harassment: member of an organization treats an employee in a disparate manner because of that person's sex, race, religion, age,  or other protective classification
    ...
    - cyberbullying: sending unpleasant or defamatory remarkds to/about a colleague and posting negative comments
  ...
  - fundamental impact on HR (i.e. areas that HR must pay attention to, even if they know the intent is not to discriminate):
  ...
  - contract compliance policy: required compliance with the Employment Equity Act if doing business with the federal government
  - **pay equity**
...
- obey the law
- both current priority and long-range strategic plans follow employment equity requirements
...
- less women at management positions than men
...
- workplace diversity: important characteristics that influence an employee's values, perceptions of self and others, behaviours, and interpretation of events around him/her
...
- second dimensions of diversity:
  ...
  - **income levels**
- managing diversity
  - organization is a mosaic where employees with varying beliefs, cultures, values, and behaviour patterns come together to create a whole organization and where these differences are acknowledged and accepted
  - if effective will add value
  - treat employees as individuals rather than as numbers or categories
- stereotyping
  - cultural conventions and valuees set "rules"

### Strategic importance of diversity management

- changing workforce
  - workforce of the past: male, white, approximately 30 years old, and usually held a high school diploma or lower 
  - today's workforce: includes women, people of ethnic minorities, native Canadians, people with physical disabilities, and people with alternative lifestyles 
  - diversity management is mandatory for effective hr
- importance of human capital
  - changes in production technology
  - "intellectual capitalism" and knowledge-intensive firms
  - knowledge worker may be the key to the success or failure of the firm
- diversity as a competitive advantage
  - globalization and changing domestic markets
  - important for Canada
- increasing role of work teams
  - charged with task accomplishment to enable firms to distance themsleves from the competitors and ensure survival
  - differences of team members are considered as "value added"
  - more than a HR management issue, but tied to the strategic plan
...
### Current industry practivies

- **diversity training programs**
  - learn new skills to manage and motivate a diverse workforce
  - create awareness of the bottom-line impact of diversity management and the role of managers, supervisors, and co-workers in creating a work climate that is found comfortable by all employees 
  - **awareness training**: creating an understanding of the need for managing and valuing diversity
  - **skill-building training**: educates employees on specific cultural differences and how to respond to differences in the workplace
  - **content training**: should a training program focus solely on the knowledge and skills related to a single culture -> usually more than one
  - **process training**: supervisors and employees have to learn about diversity in a process-oriented program
- **mentoring programs**
  - women or members of visible minorities and other disadvantaged groups are encouraged to work with a senior manager who acts like a friend, philosopher, and guide in achieving career success within the firm 
  - day-to-day performance and long-term career advice
- **alternate work arrangements**
  - remove negative factors
  - e.g. women have multiple/conflicting role demands from work and family, older workers, etc.
  - such as flexible work hours, telecommuting, extended leave, job sharing, etc. 
- **apprenticeships**
  - similar to mentoring except that they relate to junior-level or technical jobs and often involve working with prospective employees before they formally join the organization 
  - useful to attract disadvantaged group members
- **support groups**
  - provide a nurturing climate for emplooyees who may otherwise feel unwanted or shut out
  - prevent loneliness and alienation (that results in high turnover)
- **communication standards**
  - to avoid offending members
...
- **environmental**
  ...
  - **employee echange programs**: one-year leave and join another organization
...
- **succession planning**
  - ensure that there are a sufficient number of candidates for key positions ready to take over if an unexpected vacancy occurs
  - crucial for the survival of a company
- **human resource planning**
  - robust planning process for different programs to determine demand and supply
  - contribute to career planning efforts of employees, help move to new roles
- **training & development function**
  - highly interdependent functions
  - aligning the needs of the employee with organizational needs
- **performance management**
  - critical to ensuring that employees receive effective feedback with respect to their performance
  - ensure tight link between performance feedback, employee development, and career planning efforts

#### Use technology to support career planning efforts

- enterprisewide applications with career paths online through a secure portal
- intranet for career counselling purposes
- active career planning:
  - Develops Promotable Employees
  - Lowers Turnover 
  - Furthers Employee Growth 
  - Reduces Hoarding (keeping on to)
  - Satisfies Employee Needs 
  - Assists Organizations Meet Legal Requirements such as Employment Equity Plans
