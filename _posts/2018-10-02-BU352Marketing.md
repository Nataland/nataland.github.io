...
|                | B2B                                                          | B2C                                                          |
| -------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| market         | "4" cookie plants in ON<br />$1000's for truck load<br />demand based forecast<br />forecast = order | consumers all over ontario shopping at grocery stores<br />$2.99/purchase<br />decide to bake tonight |
| product        | adjusted to meet needs (size, cocoa content, etc)            | all "chips" same/standard                                    |
| buying process | RFP sent & responded to<br />purchasing dept involved<br />sales rep involved<br />negotiate $, ship, discount | go to grocery store to buy<br />finished package purchased<br />price paid is the price on shelf<br />on shelf coupon used |
| marketing mix  | sales rep focused (1 on 1 discussions & assistance)          | consumer marketing focus (ads in magazines/TV/other)         |
